#!/bin/bash
#SBATCH --job-name=ResMVP
#SBATCH --output=/home/msai/srihari003/Symm3dTri/SymmCompletion/logs/resume_mvp_%j.out
#SBATCH --error=/home/msai/srihari003/Symm3dTri/SymmCompletion/logs/resume_mvp_%j.err
#SBATCH --gres=gpu:1
...
CONFIG=${CONFIG:-cfgs/MVP16K_models/SymmCompletion_500.yaml}
EXP_NAME=${EXP_NAME:-train_mvp}
...
CKPT_DIR="./experiments/SymmCompletion_500/MVP16K_models/${EXP_NAME}"
