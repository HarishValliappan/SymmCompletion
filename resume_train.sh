#!/bin/bash
#SBATCH --job-name=SymmTriP_PCN
#SBATCH --output=/home/msai/srihari003/Symm3dTri/SymmCompletion/logs/train_pcn_%j.out
#SBATCH --error=/home/msai/srihari003/Symm3dTri/SymmCompletion/logs/train_pcn_%j.err
#SBATCH --gres=gpu:1
...
# CUDA headers from PyPI nvidia packages
...
# Free any lingering GPU memory
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

CONFIG=${CONFIG:-cfgs/PCN_models/SymmCompletion_450.yaml}
...
CKPT_DIR="./experiments/SymmCompletion_450/PCN_models/${EXP_NAME}"
