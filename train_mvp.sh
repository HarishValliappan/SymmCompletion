#!/bin/bash
#SBATCH --job-name=TriP_MVP
#SBATCH --output=/home/msai/srihari003/Symm3dTri/SymmCompletion/logs/train_mvp_%j.out
#SBATCH --error=/home/msai/srihari003/Symm3dTri/SymmCompletion/logs/train_mvp_%j.err
#SBATCH --gres=gpu:1
